...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CommandOverride)(nil), (*config.CommandOverride)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_CommandOverride_To_config_CommandOverride(a.(*CommandOverride), b.(*config.CommandOverride), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CommandOverride)(nil), (*CommandOverride)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CommandOverride_To_v1beta1_CommandOverride(a.(*config.CommandOverride), b.(*CommandOverride), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CommandOverrideFlag)(nil), (*config.CommandOverrideFlag)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_CommandOverrideFlag_To_config_CommandOverrideFlag(a.(*CommandOverrideFlag), b.(*config.CommandOverrideFlag), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CommandOverrideFlag)(nil), (*CommandOverrideFlag)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CommandOverrideFlag_To_v1beta1_CommandOverrideFlag(a.(*config.CommandOverrideFlag), b.(*CommandOverrideFlag), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_CommandOverride_To_config_CommandOverride(in *CommandOverride, out *config.CommandOverride, s conversion.Scope) error {
	out.Command = in.Command
	out.Flags = *(*[]config.CommandOverrideFlag)(unsafe.Pointer(&in.Flags))
	return nil
}

// Convert_v1beta1_CommandOverride_To_config_CommandOverride is an autogenerated conversion function.
func Convert_v1beta1_CommandOverride_To_config_CommandOverride(in *CommandOverride, out *config.CommandOverride, s conversion.Scope) error {
	return autoConvert_v1beta1_CommandOverride_To_config_CommandOverride(in, out, s)
}

func autoConvert_config_CommandOverride_To_v1beta1_CommandOverride(in *config.CommandOverride, out *CommandOverride, s conversion.Scope) error {
	out.Command = in.Command
	out.Flags = *(*[]CommandOverrideFlag)(unsafe.Pointer(&in.Flags))
	return nil
}

// Convert_config_CommandOverride_To_v1beta1_CommandOverride is an autogenerated conversion function.
func Convert_config_CommandOverride_To_v1beta1_CommandOverride(in *config.CommandOverride, out *CommandOverride, s conversion.Scope) error {
	return autoConvert_config_CommandOverride_To_v1beta1_CommandOverride(in, out, s)
}

func autoConvert_v1beta1_CommandOverrideFlag_To_config_CommandOverrideFlag(in *CommandOverrideFlag, out *config.CommandOverrideFlag, s conversion.Scope) error {
	out.Name = in.Name
	out.Default = in.Default
	return nil
}

// Convert_v1beta1_CommandOverrideFlag_To_config_CommandOverrideFlag is an autogenerated conversion function.
func Convert_v1beta1_CommandOverrideFlag_To_config_CommandOverrideFlag(in *CommandOverrideFlag, out *config.CommandOverrideFlag, s conversion.Scope) error {
	return autoConvert_v1beta1_CommandOverrideFlag_To_config_CommandOverrideFlag(in, out, s)
}

func autoConvert_config_CommandOverrideFlag_To_v1beta1_CommandOverrideFlag(in *config.CommandOverrideFlag, out *CommandOverrideFlag, s conversion.Scope) error {
	out.Name = in.Name
	out.Default = in.Default
	return nil
}

// Convert_config_CommandOverrideFlag_To_v1beta1_CommandOverrideFlag is an autogenerated conversion function.
func Convert_config_CommandOverrideFlag_To_v1beta1_CommandOverrideFlag(in *config.CommandOverrideFlag, out *CommandOverrideFlag, s conversion.Scope) error {
	return autoConvert_config_CommandOverrideFlag_To_v1beta1_CommandOverrideFlag(in, out, s)
}
